...
import advsearch.maria.minimax as minimax          
import advsearch.maria.tttm_minimax as tttm_agent  
...
class TestAlphaBetaTTTM(unittest.TestCase):
    ...
    def test_utility(self):
        """
        Esse teste verifica a funcao utility em advsearch.maria.tttm_minimax
        """
